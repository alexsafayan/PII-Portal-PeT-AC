            ...
            <div>
                {this.state.score > 0 ? 
                    <div className="text-center">
                        ...
                        {this.state.entity.hometown ? <tr><td>hometown</td><td>identity theft</td><td>low</td><td>{this.state.sources.hometown}</td><td>{this.state.datesCollected.hometown}</td></tr> : null}
                        ...
                        {this.state.entity.interests ? <tr><td>interests</td><td></td>phishing<td>low</td><td>{this.state.sources.interests}</td><td>{this.state.datesCollected.interests}</td></tr> : null}
                        {this.state.entity.political ? <tr><td>political views</td><td>discrimination</td><td> high</td><td>{this.state.sources.politicalViews}</td><td>{this.state.datesCollected.politicalViews}</td></tr> : null}
                        {this.state.entity.religious ? <tr><td>religious views</td><td>discrimination</td><td> high</td><td>{this.state.sources.religiousViews}</td><td>{this.state.datesCollected.religiousViews}</td></tr> : null}
                        </tbody>
                        </Table>
                    </div> 
                    : 
